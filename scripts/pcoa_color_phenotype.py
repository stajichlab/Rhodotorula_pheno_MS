...
Two views of the same ordination are written:
  - pcoa_color_by_species.png/.pdf : points colored by species (same
    palette/convention as the MS feature ordinations).
  - pcoa_color_swatches.png/.pdf   : points colored by the strain's own
    measured color (Lab -> sRGB, D65, clipped to gamut) -- lets you see
    directly whether nearby points in the ordination actually look alike.
